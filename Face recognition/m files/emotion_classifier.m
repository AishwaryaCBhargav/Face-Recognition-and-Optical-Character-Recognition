...
imgFolder = fullfile(path, 'emotion_classifier');
...
trainingSets = numel(training)  ;       % number of categories (04)
...
%% Train SVM using extracted HOG features and class labels 0-3
emotionClassifier = fitcecoc(trainingFeatures,trainingLabel);

%% Extract HOG Features for Test Set

testSets = numel(test);         % number of categories (04)
